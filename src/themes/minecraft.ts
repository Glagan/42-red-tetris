...
export default <Theme>{
	...
	backgrounds: [
		{
			left: {
				picture: "https://user-images.githubusercontent.com/36163709/38576955-e4fdeda4-3cff-11e8-839f-e5d8f16bb63c.png",
			},
			right: {
				picture: "https://user-images.githubusercontent.com/36163709/38576955-e4fdeda4-3cff-11e8-839f-e5d8f16bb63c.png",
			}
		},
		{
			left: {
				_3d: {
					cube_size: 16,
					cubes: [
						Generator.background_uniform(other_block_textures[0], 1000)
					],
				}
			},
			right: {
		...
		},
		{
			left: {
				_3d: {
					cube_size: 16,
					cubes: [
						Generator.background_holed_chess(other_block_textures[0], 1000)
					],
				}
			},
			right: {
